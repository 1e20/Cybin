...
-- Full Credits to Bitch and whoever else made this 
...
function menu.Initialize(menutable)
    ...
    do
        ...
        for i = 0, wm.height - 4 do Draw:FilledRect(false, wm.pos.x, wm.pos.y + 3 + i, wm.width, 1, { 50 - i * 1.7, 50 - i * 1.7, 50 - i * 1.7, 255 }, wm.rect) end
